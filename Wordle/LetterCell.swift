  ...
  func set(style: LetterCellStyle) {
    // START YOUR CODE HERE
      switch style {
          ...
          case .correctLetterOnly:
          layer.backgroundColor = UIColor(red: 0.63, green: 0.63, blue: 0.30, alpha: 1.0).cgColor
            layer.borderColor = UIColor(red: 0.63, green: 0.63, blue: 0.30, alpha: 1.0).cgColor
          case .correctLetterAndPosition:
